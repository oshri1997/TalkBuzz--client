    ...
    <div className="w-full py-3">
      <div className="flex items-center gap-3 mb-1">
        ...
        <div>
          ...
          <span className="text-sm text-ascent-2">{moment(reply.createdAt).fromNow()}</span>
        </div>
      </div>
...
const CommentForm = ({ userInfo, id, replyAt, getComments }) => {
...
const PostCard = ({ post, userInfo, deletePost, likePost }) => {
      ...
      <div>
        <p className="text-ascent-2">
          ...
          {post.description.length > 300 &&
            (showAll === post._id ? (
              <span
                className="ml-2 cursor-pointer text-blue font-mediu"
